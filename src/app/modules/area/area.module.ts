...
@NgModule({
  declarations: [AddAreaComponent, AreaComponent, UpdateAreaComponent,  AddRegionComponent, UpdateRegionComponent, AllRegionComponent],
  imports: [
    CommonModule,
    AreaRoutingModule,
  ...
  entryComponents: [AddAreaComponent, UpdateAreaComponent, AddRegionComponent, UpdateRegionComponent, AllRegionComponent]
